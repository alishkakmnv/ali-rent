...
const fleet = [
  {
    ...
    imageAlt: 'Зелёный вилочный погрузчик Mitsubishi Grendia 1.5 тонны',
  ...
  },
  {
    ...
    imageAlt: 'Зелёный погрузчик Mitsubishi Grendia 2.5 тонны у контейнера',
    features: ['Доставка по Алматы', 'Опытный оператор', 'Топливо'],
  ...
  },
  {
    ...
    priceNote: 'за 3 часа · минимальный заказ',
    image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80',
    imageAlt: 'Жёлтый дизельный погрузчик Komatsu 3 тонны',
    features: ['Доставка по Алматы', 'Опытный оператор', 'Топливо'],
